...
const questions = [
{ question: "Which is the largest planet in our solar system?", options: ["Earth", "Jupiter", "Saturn", "Neptune"], correct: 1 },
{ question: "In which year did World War II end?", options: ["1940", "1945", "1950", "1939"], correct: 1 },
...
{ question: "Who painted the Mona Lisa?", options: ["Pablo Picasso", "Leonardo da Vinci", "Vincent van Gogh", "Michelangelo"], correct: 1 },
{ question: "Which gas do humans need to breathe to survive?", options: ["Oxygen", "Nitrogen", "Carbon Dioxide", "Helium"], correct: 0 },
...
{ question: "In which year did humans first land on the moon?", options: ["1965", "1969", "1972", "1975"], correct: 1 },
{ question: "Which is the fastest land animal?", options: ["Cheetah", "Horse", "Leopard", "Lion"], correct: 0 },
{ question: "What is the capital of Australia?", options: ["Sydney", "Melbourne", "Canberra", "Perth"], correct: 2 },
{ question: "Which is the longest river in the world?", options: ["Nile", "Amazon", "Yangtze", "Mississippi"], correct: 0 },
{ question: "Which is the largest ocean on Earth?", options: ["Atlantic Ocean", "Pacific Ocean", "Indian Ocean", "Arctic Ocean"], correct: 1 },
{ question: "What is the freezing point of water in Celsius?", options: ["0", "32", "-1", "100"], correct: 0 },
{ question: "Which country invented paper?", options: ["Egypt", "China", "India", "Greece"], correct: 1 },
{ question: "Who is known as the Father of Computers?", options: ["Charles Babbage", "Alan Turing", "Bill Gates", "Steve Jobs"], correct: 0 },
{ question: "Which planet is known as the Red Planet?", options: ["Mercury", "Mars", "Venus", "Jupiter"], correct: 1 },
{ question: "Which animal is known as the Ship of the Desert?", options: ["Camel", "Horse", "Elephant", "Donkey"], correct: 0 },
{ question: "How many colors are there in a rainbow?", options: ["5", "6", "7", "8"], correct: 2 },
{ question: "Which instrument is used to measure temperature?", options: ["Barometer", "Thermometer", "Hygrometer", "Anemometer"], correct: 1 }
