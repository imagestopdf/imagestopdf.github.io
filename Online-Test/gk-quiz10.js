...
const questions = [
{ question: "Which is the smallest country in the world by area?", options: ["Monaco", "Vatican City", "San Marino", "Liechtenstein"], correct: 1 },
...
{ question: "Which planet is known as the 'Morning Star'?", options: ["Venus", "Mars", "Jupiter", "Mercury"], correct: 0 },
{ question: "In which year did World War II end?", options: ["1942", "1945", "1939", "1948"], correct: 1 },
{ question: "Which country invented paper?", options: ["Egypt", "India", "China", "Greece"], correct: 2 },
{ question: "What is the currency of Japan?", options: ["Yuan", "Won", "Ringgit", "Yen"], correct: 3 },
{ question: "Which ocean is the largest in the world?", options: ["Atlantic", "Indian", "Pacific", "Arctic"], correct: 2 },
{ question: "Which element has the chemical symbol 'O'?", options: ["Oxygen", "Osmium", "Oxide", "Orpiment"], correct: 0 },
...
{ question: "Which continent is the Sahara Desert located in?", options: ["Asia", "Africa", "Australia", "South America"], correct: 1 },
{ question: "What is the national animal of Australia?", options: ["Kangaroo", "Koala", "Emu", "Platypus"], correct: 0 },
{ question: "Which metal is liquid at room temperature?", options: ["Mercury", "Aluminium", "Silver", "Copper"], correct: 0 },
{ question: "How many sides does a hexagon have?", options: ["6", "5", "7", "8"], correct: 0 },
{ question: "Which city is known as the 'City of Love'?", options: ["Venice", "Paris", "Rome", "Florence"], correct: 1 },
{ question: "What is the boiling point of water at sea level in Celsius?", options: ["90°C", "100°C", "110°C", "120°C"], correct: 1 },
{ question: "Which is the largest mammal in the world?", options: ["African Elephant", "Blue Whale", "Giraffe", "Hippopotamus"], correct: 1 },
{ question: "Which country gifted the Statue of Liberty to the USA?", options: ["France", "United Kingdom", "Spain", "Germany"], correct: 0 }
];
